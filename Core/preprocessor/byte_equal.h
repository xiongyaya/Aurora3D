...
#include<core/preprocessor/bit4x4_equal.h>

#define A3D_PP_BYTE_EQUAL(byte1, byte2) A3D_PP_BYTE_EQUAL_CONNECT_REPARSE( A3D_PP_BYTE_EQUAL_EXPLICIT, (A3D_PP_BYTE_UNPACK(byte1),A3D_PP_BYTE_UNPACK(byte2)) )
