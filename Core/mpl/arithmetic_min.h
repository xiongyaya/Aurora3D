...
namespace Aurora3D
{
	namespace mpl
	{
		...
		template<typename T, T t1, T... others> struct Min :public IntegralType<T, IntegralMin(t1, Min<T, others...>::value)> {};
		template<typename T, T t> struct Min<T, t> :public IntegralType<T, t> {};
		...
		template<typename T> struct TypeMin<T> :public IntegralType<typename T::value_type, T::value> {};
